...
namespace my_container {
    ...
    public:
        ...
        virtual iterator begin() noexcept { return iterator(sentinel->next); }
        virtual iterator end() noexcept { return iterator(sentinel); }
        virtual iterator begin() const noexcept {return iterator(sentinel->next);}
        virtual iterator end() const noexcept {return iterator(sentinel);}
        virtual const_iterator cbegin() const noexcept { return const_iterator(sentinel->next); }
        virtual const_iterator cend() const noexcept { return const_iterator(sentinel); }
        ...
        virtual const_reverse_iterator crbegin() const noexcept { return const_reverse_iterator(cend()); }
        virtual const_reverse_iterator crend() const noexcept { return const_reverse_iterator(cbegin()); }

        virtual const_reverse_iterator rbegin() const noexcept { return crbegin(); }
        virtual const_reverse_iterator rend() const noexcept { return crend(); }
        ...
        virtual void pop_back() { erase(--end()); }
        ...
        virtual void resize(size_t count, const T& value = T());
