...
T &List<T>::back() {
    if (empty()) 
        throw std::out_of_range("end() called on empty list");
    return *(--end());
}
...
template <typename T>
my_container::List<T>::iterator &my_container::List<T>::iterator::operator++() {
	node = node->next;
	return *this;
}

template <typename T>
my_container::List<T>::iterator my_container::List<T>::iterator::operator++(int) {
	Node *tmp = *this;
	++(*this);
	return tmp;
}
...
template <typename T>
my_container::List<T>::const_iterator &my_container::List<T>::const_iterator::operator++() {
	node = node->next;
	return *this;
}

template <typename T>
my_container::List<T>::const_iterator my_container::List<T>::const_iterator::operator++(int) {
	Node *tmp = *this;
	++(*this);
	return tmp;
}
